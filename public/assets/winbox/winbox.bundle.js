 ...
 */
 (function() {
    ...
    function t(a, b, c) {
        c = "" + c;
        a["_s_" + b] !== c && (a.style.setProperty(b, c),
        a["_s_" + b] = c)
    }
    ;var w = [], x, B = 0, C = 0, D, E, H, I, N, P, Q;
    function S(a, b) {
    ...
    ;
    function U(a, b, c) {
        "string" === typeof a && ("center" === a ? a = (b - c) / 2 | 0 : "right" === a || "bottom" === a ? a = b - c : (c = parseFloat(a),
    ...
    function W(a, b) {
        function c(d) {
            ...
            if (a.min)
                ...
                a.max || (x.classList.add("wb-drag"),
                (y = d.touches) && (y = y[0]) ? (d = y,
                m(window, "touchmove", g),
                m(window, "touchend", f)) : (m(window, "mousemove", g),
                m(window, "mouseup", f)),
                J = d.pageX,
                F = d.pageY,
                a.focus())
        ...
        function f(d) {
            ...
            y ? (window.removeEventListener("touchmove", g, !0),
            window.removeEventListener("touchend", f, !0)) : (window.removeEventListener("mousemove", g, !0),
            window.removeEventListener("mouseup", f, !0))
        }
        var u = a.g.getElementsByClassName("wb-" + b)[0], y, J, F;
        m(u, "mousedown", c);
        m(u, "touchstart", c, {
            passive: !1
        })
    ...
    e.minimize = function(a) {
        E && Y();
        !a && this.min ? (X(this),
        this.resize().move().focus()) : !1 === a || this.min || (w.push(this),
        V(),
    ...
    e.maximize = function(a) {
        if ("undefined" === typeof a || a !== this.max)
            this.min && X(this),
            (this.max = !this.max) ? this.addClass("max").resize(P - this.left - this.right, Q - this.top - this.bottom, !0).move(this.left, this.top, !0) : this.resize().move().removeClass("max");
        return this
    }
    ;
    e.fullscreen = function(a) {
        if ("undefined" === typeof a || a !== E)
            this.min && (this.resize().move(),
            X(this)),
            E && Y() || (this.body[I](),
            E = !0);
        return this
    ...
    e.move = function(a, b, c) {
        a || 0 === a ? c || (this.x = a ? a = U(a, P - this.left - this.right, this.width) : 0,
        this.y = b ? b = U(b, Q - this.top - this.bottom, this.height) : 0) : (a = this.x,
        b = this.y,
        this.v && (0 === a ? this.resize(P / 2, Q) : a === P - this.width && this.resize(P / 2, Q)));
    ...
    e.resize = function(a, b, c) {
        a || 0 === a ? c || (this.width = a ? a = U(a, P - this.left - this.right) : 0,
        this.height = b ? b = U(b, Q - this.top - this.bottom) : 0) : (a = this.width,
        b = this.height);
        a = Math.max(a, this.u);
        b = Math.max(b, this.s);
        t(this.g, "width", a + "px");
